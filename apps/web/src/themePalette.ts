...
export const T3_CHAT_THEME_LABEL = "Janus";
...
const T3_CHAT_LIGHT_COLORS: ThemeColors = {
  ...
  secondary: "#e9e4d9",
  secondaryForeground: "#394739",
  muted: "#e9e4d9",
  mutedForeground: "#5e695d",
  placeholder: "#6e7669",
  secondaryLabel: "#5e695d",
  iconMuted: "#5e695d",
  error: "#c23f3f",
  errorForeground: "#8d2929",
  errorSurface: "#f9e5e2",
  warning: "#f59e0b",
  warningForeground: "#b05109",
  warningSurface: "#fcf0ea",
  update: "#3d6b4d",
  updateForeground: "#31593f",
  updateSurface: "#e0ecdf",
  accentSurface: "#e0ecdf",
  accentSurfaceForeground: "#29352b",
  messageSurface: "#e4ece1",
  messageForeground: "#29352b",
  ...
  sidebarControlSurface: "#e4ded3",
  sidebarRowHover: "#f6f2e9",
  sidebarRowActive: "#fffdf7",
  sidebarRowSelected: "#fffdf7",
  sidebarBorder: "#ded7ca",
  terminalBackground: "#f7f3ea",
  terminalForeground: "#29352b",
  terminalCursor: "#3d6b4d",
  terminalSelection: "#d9e6d7",
  terminalScrollbar: "#c9c3b6",
  terminalScrollbarHover: "#aaa99d",
};
...
const T3_CHAT_DARK_COLORS: ThemeColors = {
  ...
  focus: "#a4d4a8",
  accent: "#a4d4a8",
  accentForeground: "#102017",
  secondary: "#334033",
  secondaryForeground: "#e3e9df",
  muted: "#344034",
  mutedForeground: "#c6cfc4",
  placeholder: "#bcc6b9",
  secondaryLabel: "#c0c9be",
  iconMuted: "#c0c9be",
  error: "#f08080",
  errorForeground: "#ffd9d6",
  errorSurface: "#482a28",
  warning: "#f59e0b",
  warningForeground: "#fbbf24",
  warningSurface: "#412f20",
  update: "#a4d4a8",
  updateForeground: "#dff2df",
  updateSurface: "#314331",
  accentSurface: "#314331",
  accentSurfaceForeground: "#e7f0e5",
  messageSurface: "#2e3a2e",
  messageForeground: "#f1f4ec",
  ...
  terminalCursor: "#a4d4a8",
  terminalSelection: "#3b4a3b",
  terminalScrollbar: "#435043",
  terminalScrollbarHover: "#566456",
};
