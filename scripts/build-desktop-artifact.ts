...
export const resolveGitHubPublishConfig = Effect.fn("resolveGitHubPublishConfig")(function* (
  ...
  const configuredRepository = Option.getOrUndefined(env.updateRepository)?.trim();
  if (configuredRepository && configuredRepository !== "zgbrenner/janus") return undefined;
  const rawRepo = "zgbrenner/janus";
...
export function resolveDesktopProductName(_version: string): string {
  return desktopPackageJson.productName ?? "Janus";
}
...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
  ...
  const buildConfig: Record<string, unknown> = {
    ...
    artifactName: "Janus-${version}-${arch}.${ext}",
