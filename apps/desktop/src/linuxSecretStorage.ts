...
function getGnomeKeyringRemediationMessage(): string {
  return "Janus could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Janus.";
}

function getKWalletRemediationMessage(): string {
  return "Janus could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Janus.";
}
