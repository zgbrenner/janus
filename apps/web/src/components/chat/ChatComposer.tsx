...
import { buildPersistedDraftAttachments } from "./composerDraftAttachments";
...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
      ...
      const builtInSlashCommandItems = [
        {
          ...
          command: "model",
          label: "/model",
          description: "Switch response model for this task",
        },
        ...(planModeUiEnabled
          ? ([
              {
                ...
                command: "plan",
                label: "/plan",
                description: "Switch this task into plan mode",
              },
              {
                id: "slash:default",
                type: "slash-command",
                command: "default",
                label: "/default",
                description: "Switch this task back to normal build mode",
              },
            ] as const)
          : []),
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        const serialized = await buildPersistedDraftAttachments(
          composerImages,
          existingPersistedById,
        );
        if (cancelled) return;
  ...
  return (
    <form
      ...
      className="janus-composer mx-auto w-full min-w-0 max-w-3xl"
                        ...
                        : projectSelectionRequired
                          ...
                          : noProviderAvailable
                            ...
                            : phase === "disconnected"
                              ...
                              : "Describe what you want to accomplish. Use @ for files, $ for skills, or / for commands."
                }
