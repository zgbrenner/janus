...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.knowledgeList]: AuthOrchestrationReadScope,
  [WS_METHODS.knowledgeRead]: AuthOrchestrationReadScope,
  [WS_METHODS.knowledgeWrite]: AuthOrchestrationOperateScope,
